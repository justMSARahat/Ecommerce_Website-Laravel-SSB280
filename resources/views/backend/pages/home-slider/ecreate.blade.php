		...
		<div class="col-sm-12 col-xl-12">
			<div class="br-section-wrapper">
				...
				<div class="bd rounded table-responsive">
					<form action="{{ route('mslider.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
							...
							<div class="row mg-b-15">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input class="form-control" type="text" name="name" placeholder="Enter Slider Title" autocomplete="off">
									</div>
								</div>
                                ...
                                <input type="hidden" name="slide_type" value="2">
