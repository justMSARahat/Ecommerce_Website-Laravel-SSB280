				...
				<form action="{{ route('division.store') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-layout form-layout-1">
			            <div class="row mg-b-25">
			              ...
			              <div class="col-lg-12">
			                <div class="form-group">
			                  ...
			                  <input class="form-control" type="text" name="name" placeholder="Enter Division Name" autocomplete="off">
			                </div>
			              </div><!-- col-4 -->
			            ...
			            <div class="form-layout-footer">
			              <button class="btn btn-info" type="submit">Add New Division</button>
